        ...
        CKEDITOR.on('dialogDefinition', function(evt){
            ...
            if (name === 'image') {
                ...
                infoContent.add({
                    ...
                    html: '<img src="/images/loading.gif" alt="fjpg" />'
                }, 'browse');
                ...
                infoContent.add({
                    ...
                    onClick: function () {
                        ...
                        // 文件上传控件
                        var currentFrame = frames[iframeName];
                        var doc;
                        if (document.all){//IE
                            doc = currentFrame.document;
                        }else{//Firefox or Chrome
                            doc = currentFrame.contentDocument;
                        }
                        fileInput = doc.getElementsByTagName('input')[0];
                        // 激活文件上传控件
                        fileInput.click();
                    }
                }, 'loading');
                ...
                infoContent.add({
                    ...
                    onChange: function () {
                        ...
                        function listen () {
                            ...
                            responseElem = doc.getElementById(options.responseId);
